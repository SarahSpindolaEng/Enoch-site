...
// Chat de suporte flutuante — só existe pra quem já está logado, porque a
// conversa é vinculada à conta (user_id em contact_messages). Visitante sem
// conta continua usando só o formulário normal da página de Contato.
export function SupportChat() {
  ...
  // recarrega (ex: ao abrir a página) — não atualiza sozinha com a página aberta.
            ...
            <div className="flex-1 overflow-y-auto p-3">
              {threads.length === 0 ? (
                <p className="p-3 text-center text-xs text-muted-foreground">
                  Nenhuma conversa ainda. Mande uma mensagem pelo formulário de contato pra começar.
                </p>
              ) : (
